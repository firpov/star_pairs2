...
#
# Convert from equatorial coordinate system to (local) horizontal coordinate
# system. Plot the map of pair stars available in the sky at the moment it is
# executed. It is interactive, stars can be selected with a left click, and the
# information needed to tune is displayed in the terminal window.
#
# Afterwards, when the stars pair is chosen, it needs of the TCC for slewing
# the telescope.
#
...
LST = float(LST[0:2]) + float(LST[3:5]) / 60. + \
    float(LST[6:10]) / 3600.  # Hours
